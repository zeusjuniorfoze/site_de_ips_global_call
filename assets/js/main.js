...
(function () {
  ...
  document.querySelectorAll("#navmenu a").forEach((navmenu) => {
    navmenu.addEventListener("click", (e) => {
      // ⚠️ si c’est un dropdown-toggle => ne ferme pas la nav
      if (navmenu.classList.contains("dropdown-toggle")) {
        e.preventDefault(); // empêche juste le scroll
        return;
      }

      // si c’est un lien normal => fermer le menu
